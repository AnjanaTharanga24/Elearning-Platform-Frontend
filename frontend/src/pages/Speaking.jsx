...
export default function Speaking() {
  return (
    ...
    <section className="title-area position-relative mt-4">
    <div className="container">
      <div className="main-max-width">
        <div className="page-title-content">
         
        <img src="assets/img/all-img/speaking1.jpg" alt="image" style={{width:"1000px" , height:"500px"}}/>
    ...
    <div>
      <h1 style={{marginTop:"40px"}}>Choose a speaking lesson</h1>
    </div>
              ...
              <div className="single-blog-box">
                <div className="image position-relative">
                  <a href="blog-details.html">
                    <img src="assets/img/all-img/speaking1.jpg" alt="image" />
                  </a>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div className="content">
                  ...
                  <p>
                    Our approach to it is unique around how to work and how to get
                    hands-on with you like
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
